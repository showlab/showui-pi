...
def _extract_complementary_data(batch: dict[str, Any]) -> dict[str, Any]:
    ...
    bbox_key = {"bbox_norm": batch["bbox_norm"]} if "bbox_norm" in batch else {}
    time_weights_key = {"loss_time_weights": batch["loss_time_weights"]} if "loss_time_weights" in batch else {}
    is_grounding_key = {"is_grounding": batch["is_grounding"]} if "is_grounding" in batch else {}

    return {**pad_keys, **task_key, **index_key, **task_index_key, **bbox_key, **time_weights_key, **is_grounding_key}
