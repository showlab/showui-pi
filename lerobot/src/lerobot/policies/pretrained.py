...
from safetensors.torch import load_model as load_model_as_safetensor, save_model as save_model_as_safetensor, save_file
...
class PreTrainedPolicy(nn.Module, HubMixin, abc.ABC):
    ...
    def _save_pretrained(self, save_directory: Path) -> None:
        ...
        # Use save_file with contiguous state_dict to avoid shared-tensor errors from DDP
        state_dict = {k: v.contiguous() for k, v in model_to_save.state_dict().items()}
